...
<link href="${conPath }/css/attraction/ListAtc.css" rel="stylesheet">
			...
			<form action="${conPath }/attraction/listAtc.do">
				...
				<select name="schItem">
					...
					<option value="all" 
						...
						>존+나이+키</option>
					<option value="zname" 
						<c:if test="${param.schItem eq 'zname' }">selected="selected"</c:if>
						>존이름</option>
					<option value="atold"
						<c:if test="${param.schItem eq 'atold' }">selected="selected"</c:if>
						>나이</option>
					<option value="atheight"
						<c:if test="${param.schItem eq 'atheight' }">selected="selected"</c:if>
						>키</option>
				</select>
					...
					<c:if test="${status.index%5==0}">
				   	...
				   	<td>
				   		<a href="${conPath }/attraction/detailAtc.do?atcode=${list.atcode}&pageNum=${paging.currentPage}">
							<img src="${conPath }/attractionImg/${list.atimage}"><br>
							${list.atname }<br>
							${list.zname } <br>
						</a>
					</td>
	...
	<div class="container" >
			<div id="srchzone" >
				...
				<div class="after attr" style="display:none;">
					<div class="">
						<div class="valueDiv">
							<p class="tit">위치</p><p class="value location">전체</p>
						</div><!--
						-->
						<div class="valueDiv">
							<p class="tit">나이</p><p class="value">전체</p>
						</div><!--
						--><div class="valueDiv">
							<p class="tit">키</p><p class="value cm"></p>
						</div><!--
						--><div class="valueDiv chk">
							<p class="tit">보호자</p><p class="value ">보호자 탑승</p>
						</div>
					</div>
					<a href="javascript:" class="srchBt"><img src="/common/images/btn/srch_btn2.png" alt="검색하기" /></a>
					<a href="javascript:" class="resetBt reset"><img src="/common/images/btn/srch_reset2.png" alt="리셑" /></a>
				</div>

				<div class="openDiv">
					<p class="tit"><span class="fBold">나에게 맞는</span> 어트랙션을 찾아보세요!</p>
					<div class="selArea">
						<div class="">
							<p class="selTit">위치</p>
							<div class="openSel">
					...
					<div class="btnArea">
						<a href="javascript:" id="search">조회하기</a>
						<a href="javascript:" class="resetBtn reset"><img src="/common/images/btn/srch_reset.png" alt="" /></a>
					</div>
			...
			<div id="attrctnList" class="listType2">
			</div>
