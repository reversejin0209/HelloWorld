		...
		<div class="content">
			...
			<div class="youtubeArea attrctn">
				<div class='embed-container'>
					<iframe src='${detailAtc.atyoutube }' frameborder='0' allowfullscreen></iframe>
				</div>
			</div>
			<div class="rideInfo">
				<div class="cardArea">
					<div class="card">
						<p class="icon"><img src="${conPath }/attractionImg/rideInfo_card_icon3.png" alt="" /></p>
						<p class="txt">탑승인원</p>
						<div class="boldDiv">
					...
					<div class="card">
						<p class="icon"><img src="${conPath }/attractionImg/rideInfo_card_icon4.png" alt="" /></p>
						<p class="txt">이용정보</p>							
						<div class="lightDiv">
							<p class="lightTxt">
							${detailAtc.atheight }cm이상탑승가능<br>
							${detailAtc.atweight }kg이하 탑승 가능</p>
						</div>
					</div>
				</div>
				<p class="subTit">탑승제한</p>
				<div class="restArea">
					<p><img src="${conPath }/attractionImg/bear.png" alt="음주" /><br>음주</p>
					<p><img src="${conPath }/attractionImg/woman.png" alt="임산부" /><br>임산부</p>
					<p><img src="${conPath }/attractionImg/heart.png" alt="심/혈관계 질환자" /><br>심/혈관계 질환자</p>
					<p><img src="${conPath }/attractionImg/dake.png" alt="디스크 환자" /><br>디스크 환자</p>
				</div>
			</div>
			<div class="mapInfo">
				<p class="subTit">위치정보</p>
					...
					<div class="btnArea">
					<button class="btn_purple" onclick="location.href='${conPath}/attraction/listAtc.do?method=ListAtc&schItem=&schWord='">목록</button>
				</div>
			</div>	
		</div>
